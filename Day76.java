...
class Day76 {
    ...
    public static void main(String[] args) {
        ...
        int n = 5; // Example value for n, you can change it accordingly
        int k = 3; // Example value for k, you can change it accordingly
        long result = solution.findNthNumer(n, k);
